...
<div class="row all-pckges">
    ...
    foreach($pmpro_levels as $level)
    {
        if(isset($current_user->membership_level->ID))
            ...
            $current_level = false;
        ?>
        <div class="col-md-4 single-pckg">
            <div class="packages_detail">
			<div class="pckg-header">
                <h2><?php echo $current_level ? "{$level->name}" : $level->name?></h2>
                <br/>
                <p>
                    <?php
                ...
                <div class="buttons">
                    <?php if(empty($current_user->membership_level->ID)) { ?>
                        <a class="pmpro_btn pmpro_btn-select" href="<?php echo pmpro_url("checkout", "?level=" . $level->id, "https")?>"><?php _e('Lets Get Started', 'paid-memberships-pro' );?></a>
